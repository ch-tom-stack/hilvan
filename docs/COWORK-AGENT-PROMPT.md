...
- `hilvan_cotizacion_editar_item(item_id, precio_cliente?, nombre?, descripcion?, incluido?, cantidad?, dias?)` — edita un ítem existente (al menos un campo). Reversible (restaura los valores previos).

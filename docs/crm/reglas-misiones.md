...
porque la app lo detecte. Eso no es una concesión, es la decisión de fondo, y
abre el campo entero: una misión **puede pedir algo que Hilván no ve**. Una
llamada, una conversación, dejar un archivo ordenado en otra parte.
...
## Áreas — un mapa para orientarse

No es una matriz de asignación ni una lista de permisos: es dónde mirar cuando
hay que pensar una misión para alguien. Natalia y Simón montan "en ocasiones",
los dos proponen contenidos, los dos hacen CRM. Los bordes se mueven y está bien
que se muevan.
...
- **La pertenencia está instrumentada.** Los 58 prospectos tienen responsable:
  ...
  persona.
- **La ejecución no.** Las 56 interacciones de los últimos 60 días quedaron
...
Trae proyectos propios y no tiene CRM. Se ha resistido a usar Hilván de forma
activa y hay interés en buscarle incentivos.

Antes de intentarlo, la contradicción: **la misión vive dentro de la app que él
no abre.** No puede atraer a quien no entra — llega a un lugar donde no está. O
el incentivo lo alcanza por fuera, o entrar tiene que valerle más que la
fricción. No es un problema de misiones, es anterior.

### Practicantes

Cuando haya, las primeras misiones son de **familiarización con la
organización**, no de producción.

Es el mejor calce que tiene esto: son acotadas, tienen orden, terminan de verdad
—se deja de ser nuevo— y son el único caso donde inventar la misión es legítimo,
porque el objetivo *es* hacerla y no el resultado que produce.

## Visibilidad

Cada persona ve las suyas. Tomás ve las de todos y participa en crearlas.

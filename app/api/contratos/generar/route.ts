  ...
  return new Document({
    sections: [{
      children: [
        ...
        ...clausula(2, 'HONORARIOS', `Las partes acuerdan una remuneración de $_____ CLP por jornada (${col.tipo_documento === 'boleta' ? 'sujeto a la retención legal de honorarios vigente' : col.tipo_documento === 'bet' ? 'mediante BET' : 'según instrumento acordado'}). El pago se realizará dentro de los 10 días hábiles siguientes a la entrega del documento tributario correspondiente.`),
